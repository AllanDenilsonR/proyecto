"use strict";
(self["webpackChunkskote"] = self["webpackChunkskote"] || []).push([["src_app_pages_carrera_carrera_module_ts"],{
...
class CarreraComponent {
    ...
    guardar() {
        ...
        if (this.existe(this.carrera.nombrecarrera.toLowerCase())) {
    ...
    existe(nombre) {
        return this.carreras.some(carrera => carrera.nombrecarrera.toLowerCase() === nombre);
    }
    openModalA(content) {
