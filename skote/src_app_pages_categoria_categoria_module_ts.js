"use strict";
(self["webpackChunkskote"] = self["webpackChunkskote"] || []).push([["src_app_pages_categoria_categoria_module_ts"],{
...
class ListarCategoriaComponent {
    ...
    guardar() {
        ...
        if (this.existe(this.categoria.nombre.toLowerCase())) {
    ...
    existe(nombre) {
        return this.categorias.some(categoria => categoria.nombre === nombre);
    }
    //PARA LA AYUDA
    openModalA(content) {
